  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "expr": parse_expr,
        "quotedexpr": parse_quotedexpr,
        "moreexpr": parse_moreexpr,
      ...
      function parse_expr() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            result0 = parse_quotedexpr();
          }
        }
        return result0;
      }
      
      function parse_quotedexpr() {
        var result0, result1;
        var pos0, pos1;
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, s, n) { return parseInt(s + n.join('')); })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
